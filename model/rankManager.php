...
class RankManager
{
	...
	public function rankUpdate($commentModeration,$commentValidation,$commentHidden,$commentDelete,$articleAdd,$articleUpdate,$articleDelete,$userAdministration,$userDelete,$userRankUpdate,$rankUpdate,$rank){
		$req= $this->_dbh->prepare("UPDATE rank SET comment_moderation = :comment_moderation ,comment_validation = :comment_validation, comment_delete = :comment_delete, user_administration = :user_administration, article_add = :article_add, article_update = :article_update, article_delete = :article_delete, user_delete = :user_delete, user_rank_update = :user_rank_update, rank_update = :rank_update WHERE rank= :rank");
            $req->execute(array(
