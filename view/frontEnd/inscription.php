        ...
        <form name="userInscription" id="userInscription" method="post" action="index.php?page=user_inscription" novalidate>
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="text" class="form-control" placeholder="Pseudonyme" name="userInscription" id="userInscription" required data-validation-required-message="Please enter your pseudonyme.">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="text" class="form-control" name="userEmailInscription" id="userEmailInscription" placeHolder="email" required data-validation-required-message="Please enter your email address.">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
